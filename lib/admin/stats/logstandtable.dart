...
class LogstandTable extends StatefulWidget {
  const LogstandTable({super.key});

  @override
  State<LogstandTable> createState() => _LogstandTableState();
}

class _LogstandTableState extends State<LogstandTable> {
  List<Team> teams = [];
  bool isLoading = true;
  String errorMessage = '';
