...
class TopScorerPageUsr extends StatefulWidget {
  const TopScorerPageUsr({super.key});

  @override
  State<TopScorerPageUsr> createState() => _TopScorerPageUsrState();
}

class _TopScorerPageUsrState extends State<TopScorerPageUsr> {
